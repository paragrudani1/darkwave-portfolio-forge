  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'dark-gradient': 'linear-gradient(135deg, #1A1F2C 0%, #221F26 100%)',
        'neon-gradient': 'linear-gradient(to right, #8B5CF6, #0EA5E9, #06B6D4)',
      },
      boxShadow: {
        'neon-purple': '0 0 15px rgba(139, 92, 246, 0.5)',
        'neon-blue': '0 0 15px rgba(14, 165, 233, 0.5)',
        'dark-glow': '0 4px 20px rgba(0, 0, 0, 0.3)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
